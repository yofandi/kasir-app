...
function handleSubmit() {
  ...
  formData.append('_method', 'PUT') // Untuk method spoofing ke PUT
  if (form.value.image) {
    formData.append('image', form.value.image)
  }

  Inertia.post(route('apps.categories.update', props.category.id), formData, {
    onSuccess: () => {
      Swal.fire({
        title: 'Success!',
...
<template>
  ...
  <BreadcrumbDefault :pageTitle="'Edit Category'" />

  <DefaultCard cardTitle="Edit Category" class="shadow-md">
