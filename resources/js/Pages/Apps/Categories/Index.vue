...
<template>
  ...
  >
    <h2 class="text-white font-semibold text-lg mb-4">Categories</h2>
      ...
      <table class="min-w-full table-fixed border-collapse">
        <thead>
          <tr class="bg-gray-800 text-gray-400 text-xs uppercase tracking-wider">
            <th class="w-1/4 text-left px-4 py-3">No.</th>
            <th class="w-1/4 text-left px-4 py-3">Name</th>
            <th class="w-1/4 text-left px-4 py-3">Image</th>
            <th class="w-1/2 text-left px-4 py-3">Action</th>
          </tr>
        </thead>
        <tbody>
          <tr
          ...
          >
            ...
            <td class="text-white text-sm px-4 py-3">{{ category.name }}</td>
            ...
            <td class="text-white text-sm px-4 py-3 whitespace-nowrap">
              <Link
                :href="route('apps.categories.edit', category.id)"
    ...
    <!-- pagination -->
    <Pagination :links="categories" align="end" />
  </div>
</template>
